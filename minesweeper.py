...
class MinesweeperAI():
    ...
    def inference(self):
        for sentence1 in self.knowledge:
            for sentence2 in self.knowledge:
                ...
                if sentence1.cells.issubset(sentence2.cells) and sentence1 is not sentence2:
    ...
    def add_knowledge(self, cell, count):
        ...
        undetermined_mine_count = copy.deepcopy(count)
        ...
        for neighbor in all_neighbors:
            if neighbor in self.mines:
                undetermined_mine_count -= 1
            if neighbor not in self.mines.union(self.safes):
                undetermined_neighbors.add(neighbor)

        new_sentence = Sentence(undetermined_neighbors, undetermined_mine_count)
    ...
    def make_random_move(self):
        ...
        while max_moves > 0:
            ...
            if (row, column) not in self.moves_made.union(self.mines):
                return (row, column)
